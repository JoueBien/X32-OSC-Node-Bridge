...
export type ARG_2 = [number, number]

export type ARG_3 = [number, number, number]

export type ARG_4 = [number, number, number, number]

export type ARG_6 = [number, number, number, number, number, number]
...
export const ARRAY_8: ARG_8 = [0, 0, 0, 0, 0, 0, 0, 0]
export const ARRAY_32: ARG_32 = [...ARRAY_8, ...ARRAY_8, ...ARRAY_8, ...ARRAY_8]
export const ARRAY_64: ARG_64 = [
  ...ARRAY_8,
  ...ARRAY_8,
  ...ARRAY_8,
  ...ARRAY_8,
...
export type ARG_STR_2 = [string, string]

export type ARG_STR_3 = [string, string, string]

export type ARG_STR_4 = [string, string, string, string]

export type ARG_STR_6 = [string, string, string, string, string, string]
