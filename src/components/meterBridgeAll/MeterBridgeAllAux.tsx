...
export const MeterBridgeAllAux: FC = () => {
  ...
  return <MeterBridgeBar>
    <MeterBridgeChannels channelArgs={auxSends} size={6} label="Aux Sends 1-6" channelLabels={["1", "2", "3", "4", "5", "6", undefined, undefined]} />
    <MeterBridgeChannels channelArgs={auxReturns} label="Aux Returns 1-8" channelLabels={["1", "2", "3", "4", "5", "6", "7","8"]} />
  </MeterBridgeBar>  
}